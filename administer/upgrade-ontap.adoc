...
CAUTION: AFXストレージシステムはサポートしていません link:../administer/revert-ontap.html["ONTAPのリバート"] 操作。
...
link:https://docs.netapp.com/us-en/ontap/upgrade/automated-pre-checks.html["ONTAP の自動アップグレード前チェックの実行方法を学ぶ"^]。
