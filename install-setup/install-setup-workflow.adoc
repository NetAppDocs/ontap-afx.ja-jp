...
NOTE: AFX 1KをAI Data Engine（AIDE）と共に導入する場合は、AFXシステムの電源を入れた後にAIDEデータ計算ノードをインストールしてください。詳細についてはlink:https://docs.netapp.com/us-en/ai-data-engine/install-setup/aide-hardware-requirements.html["AIDE データ計算ノードをインストールする"]を参照してください。
