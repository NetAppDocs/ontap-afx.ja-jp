...
NetApp AFXは、ハイパフォーマンスNASおよびオブジェクトワークロード向けに最適化されています。このため、AFFおよびFASストレージシステムとの違いがあります。以下の機能はNetApp AFXでは利用できません。リストは主要な機能または機能領域別に整理されています。また、link:../release-notes/whats-new-9171.html["新機能"]に基づいて、お使いのONTAPリリースに対応したAFXのアップデートと変更点も確認する必要があります。
